...
?>
    <main>
        <section id="landingPage" class="fullScreenSection">
            ...
            <nav id="floating_nav_wrapper">
                <ul class="ctaNavigation">
                    ...
                    <li id="cta_cases" class="left_btn link_list_item" data-hovertext="Se mine tidligere projekter" aria-label="Se mine cases"><a href="cases.html">Cases</a></li>
                    ...
                    <li id="cta_contact" class="right_btn link_list_item" data-hovertext="Klik for at skabe kontakten" aria-label="Kontakt mig"><a href="contact.html">Kontakt mig</a></li>
                </ul>
            </nav>
        </section>
        <section id="navContent">
            <nav>
                <ul class="ctaNavigation">
                    <li class="link_list_item"><a href="cases.html">Cases</a></li>
                    ...
                    <li class="link_list_item"><a href="contact.html">Kontakt mig</a></li>
                </ul>
            </nav>
        </section>
    </main>
